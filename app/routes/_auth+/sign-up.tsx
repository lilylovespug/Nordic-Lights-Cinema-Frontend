...
export const meta = mergeMeta(() => [
  { title: 'Nordic Lights Cinema - Sign Up' },
  { name: 'description', content: 'Sign up for a Nordic Lights Cinema account.' },
  { property: 'og:title', content: 'Nordic Lights Cinema - Sign Up' },
  { property: 'og:description', content: 'Sign up for a Nordic Lights Cinema account.' },
  { property: 'og:url', content: 'https://sorachill.vercel.app/sign-up' },
  { property: 'twitter:title', content: 'Nordic Lights Cinema - Sign Up' },
  { property: 'twitter:description', content: 'Sign up for a Nordic Lights Cinema account.' },
]);
...
export const action = async ({ request }: ActionFunctionArgs) => {
  ...
  return redirectWithToast(
    ...
    ref,
    {
      type: 'success',
      title: 'Sign Up Successfully',
      description: 'Welcome to Nordic Lights Cinema!',
    },
